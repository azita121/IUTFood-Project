...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->logMessage((*reinterpret_cast< std::add_pointer_t<LogLevel>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Logger::*)(LogLevel , const QString & , const QString & );
        ...
        {
            using _q_method_type = void (Logger::*)(const QString & , const QString & );
            if (_q_method_type _q_method = &Logger::errorOccurred; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Logger::logMessage(LogLevel _t1, const QString & _t2, const QString & _t3)
{
...
// SIGNAL 1
void Logger::errorOccurred(const QString & _t1, const QString & _t2)
{
