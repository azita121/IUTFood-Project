...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (Server::*)(QTcpSocket * );
            if (_q_method_type _q_method = &Server::clientConnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (Server::*)(QTcpSocket * );
            if (_q_method_type _q_method = &Server::clientDisconnected; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (Server::*)(QTcpSocket * , const QByteArray & );
...
// SIGNAL 0
void Server::clientConnected(QTcpSocket * _t1)
{
...
// SIGNAL 1
void Server::clientDisconnected(QTcpSocket * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void Server::messageReceived(QTcpSocket * _t1, const QByteArray & _t2)
{
