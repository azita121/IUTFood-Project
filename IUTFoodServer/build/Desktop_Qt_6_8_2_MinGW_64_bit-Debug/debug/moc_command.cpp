...
static constexpr auto qt_meta_stringdata_ZN7CommandE = QtMocHelpers::stringData(
    "Command"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7CommandE[] = {
...
Q_CONSTINIT const QMetaObject Command::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7CommandE.offsetsAndSizes,
    qt_meta_data_ZN7CommandE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7CommandE_t,
        // Q_OBJECT / Q_GADGET
...
void *Command::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7CommandE.stringdata0))
