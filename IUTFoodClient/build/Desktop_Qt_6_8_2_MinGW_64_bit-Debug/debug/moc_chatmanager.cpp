...
#include "../../../src/network/chatmanager.h"
...
void ChatManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->messageRead((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->unreadCountChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        default: ;
        }
    }
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ChatManager::*)(ChatMessage * );
            if (_q_method_type _q_method = &ChatManager::messageReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ChatManager::*)(ChatMessage * );
            if (_q_method_type _q_method = &ChatManager::messageSent; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_q_method_type _q_method = &ChatManager::messageRead; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _q_method_type = void (ChatManager::*)(const QString & , int );
            if (_q_method_type _q_method = &ChatManager::unreadCountChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void ChatManager::messageReceived(ChatMessage * _t1)
{
...
// SIGNAL 1
void ChatManager::messageSent(ChatMessage * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 2
void ChatManager::messageRead(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
...
// SIGNAL 3
void ChatManager::unreadCountChanged(const QString & _t1, int _t2)
{
